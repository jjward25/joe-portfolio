      ...
      <div className='about-wrap'>
          ...
          <div className='about-content'>
            ...
            <div className='about-box'>
                ...
                <div className='about-text'>I’ve always been interested in taking a step back, observing, asking how, then why, then how else...  Playing devil’s advocate and whittling internal debates down with logic...</div>
                <div className='about-text'>I graduated from Cornell University with a degree in Political Science because of my love of debate, a strong attraction to complex things, and curiousity about the world.  I’ve been to 6 continents and almost every state.  I’d worked retail, wait staff and asset valuations before I graduated.</div>
                ...
                <div className='about-text'>My second role was to set up formal operations for a cash-poor non-profit I had volunteered with.  I led 401k enrollments, recruited new hires, set metrics and targets, and fostered a culture of continuous improvement before returning to run TD Ameritrade’s procurement analytics.  In this role I developed flexible reporting tools, led key improvement initiatives, and created ad hoc reports for our C-Suite, the SEC, House of Reps, and more.</div>
