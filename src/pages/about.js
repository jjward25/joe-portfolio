      ...
      <div className='about-wrap'>
          ...
          <div className='about-content'>
            ...
            <div className='about-box'>
                ...
                <div className='about-text'>This requires good communication - open, honest, and detail oriented. I foster an environment of trust with my engagements, acting on behalf of every team member as I help find solutions to your team's most persistent issues and give everyone more time to focus on the things they want to be doing.</div>
            </div>
