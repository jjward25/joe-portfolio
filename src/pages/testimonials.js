        ...
        <div className='testimonials-content'>
            ...
            <div className='testimonial-wrap'>
                ...
                <div className='testimonial'>
                    ...
                    <div className='testimonial-description'>Custom Dashboard built with free tools and sound statistical methods to analyze Shopify data in a repeatable way.</div>
